...
from src.live_portrait_annotation_pipeline import LivePortraitAnnotationPipeline
...
def main():
    ...
    live_portrait_pipeline = LivePortraitAnnotationPipeline(
    ...
    # live_portrait_pipeline.execute_video(args)
